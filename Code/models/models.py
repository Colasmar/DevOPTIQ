...
class Relation(db.Model):
    id = db.Column(db.Integer, primary_key=True)
    source_id = db.Column(db.Integer, db.ForeignKey('activity.id'), nullable=False)
    target_id = db.Column(db.Integer, db.ForeignKey('activity.id'), nullable=False)
    type = db.Column(db.String(50), nullable=False)  # e.g., 'trigger', 'nourishing'
    description = db.Column(db.Text, nullable=True)
